...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="bg-gradient-to-b from-orange-50 to-white py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 text-center md:text-left">
            <p className="text-orange-600 font-semibold text-sm uppercase tracking-wider mb-3">
              TikTok Marketing Expert
            </p>
            <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 leading-tight mb-4">
              Xin chào, tôi là{" "}
              <span className="text-orange-600">Lê Viết Hưng</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              ...
              <Link
                href="/blog"
                className="bg-white text-slate-700 px-6 py-3 rounded-lg font-semibold border border-slate-200 hover:border-orange-300 hover:text-orange-600 transition-colors"
              >
                Đọc blog
              </Link>
            </div>
          ...
          <div className="flex-shrink-0">
            <div className="w-40 h-40 sm:w-56 sm:h-56 rounded-full bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center text-white text-6xl font-bold shadow-xl">
              LH
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl p-8 sm:p-10 flex flex-col sm:flex-row items-center gap-6 text-white">
            <div className="text-5xl">📘</div>
            <div className="flex-1 text-center sm:text-left">
              <p className="text-orange-200 text-sm font-medium uppercase tracking-wide mb-2">Miễn phí</p>
            ...
            <a
              ...
              download
              className="flex-shrink-0 bg-white text-orange-700 font-semibold px-6 py-3 rounded-lg hover:bg-orange-50 transition-colors"
            >
              Tải về →
            </a>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/blog" className="text-sm text-orange-600 font-medium hover:underline">
              Xem tất cả →
            </Link>
          </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {recentPosts.map((post) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-slate-900 group-hover:text-orange-600 transition-colors mb-2 line-clamp-2">
                    {post.title}
                  </h3>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              ...
              <div key={item.title} className="bg-slate-50 rounded-xl p-6 text-left">
                ...
                <Link href={item.href} className="text-sm text-orange-600 font-medium hover:underline">
                  {item.label} →
                </Link>
              </div>
            ))}
